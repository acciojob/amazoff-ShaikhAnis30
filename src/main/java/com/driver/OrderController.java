...
public class OrderController {
    ...
    public ResponseEntity<Integer> getCountOfUnassignedOrders(){
        ...
        return new ResponseEntity<>(countOfOrders, HttpStatus.FOUND);
    }

    @GetMapping("/get-count-of-orders-left-after-given-time")
    public ResponseEntity<Integer> getOrdersLeftAfterGivenTimeByPartnerId(@RequestParam("time") String time, @RequestParam("Pid") String partnerId){
    ...
    public ResponseEntity<String> deletePartnerById(@PathVariable String partnerId){
        ...
        return new ResponseEntity<>(partnerId + " removed successfully", HttpStatus.GONE);
    }
    ...
    public ResponseEntity<String> deleteOrderById(@PathVariable String orderId){
        ...
        return new ResponseEntity<>(orderId + " removed successfully", HttpStatus.GONE);
    }
}
